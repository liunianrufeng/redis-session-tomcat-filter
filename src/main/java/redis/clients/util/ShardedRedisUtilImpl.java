 ...
 * <b>文件名：</b>RedisUtil.java<br/>
 * <b>创建人：</b>xuwei<br/>
 * <b>版本信息：</b><br/>
 * <b>日期：</b>2015年5月24日-上午8:59:49<br/>
 ...
 * <b>创建人：</b>xuwei<br/>
 * <b>修改人：</b>xuwei<br/>
 * <b>修改时间：</b>2015年5月24日 上午8:59:49<br/>
 * <b>修改备注：</b><br/>
 * 
 * @version 1.0.0<br/>
 * 
 */
public class ShardedRedisUtilImpl{
	// 数据源
	private ShardedJedisPool shardedJedisPool;

	/**
	 * 执行器，ShardedRedisUtil的辅助类，
	 ...
	 *         0 。
	 */
	public Long hashSet(final String key, final String field,
			final String value, final int expire) {
		return new Executor<Long>(shardedJedisPool) {
	 ...
	 */
	public String hashMultipleSet(final String key,
			final Map<String, String> hash, final int expire) {
		return new Executor<String>(shardedJedisPool) {
	...
	public List<List<String>> batchHashMultipleGet(
		...
		return new Executor<List<List<String>>>(shardedJedisPool) {
			...
			List<List<String>> execute() {
				...
				for (Pair<String, String[]> pair : pairs) {
					responses
							.add(pipeline.hmget(pair.getKey(), pair.getValue()));
				}
				pipeline.sync();
	 ...
	 */
	public void batchListPushTail(final String key, final String[] values,
	 ...
	 * @return null
	 */
	public Object updateListInTransaction(final String key,
	 ...
	 * @return 被成功添加的新成员的数量，不包括那些被更新的、已经存在的成员。
	 */
	public Long addWithSortedSet(final String key,
